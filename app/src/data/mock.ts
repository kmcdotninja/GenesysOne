...
export const MARKET_LISTINGS: MarketListing[] = [
  ...
  { id: 'm7', mineral: 'copper', grade: 32.5, quantity: 80, unit: 'ton', priceAmount: 18400000, priceCurrency: 'NGN', state: 'Gombe', status: 'approved', certified: true, sellerName: SELLER_CO, sellerVerified: true, sellerRating: 4.5, deliveryMode: 'delivery', locationType: 'warehouse', trend: spark(6), createdAt: '10 Feb 2025', passportNumber: 'GO-CU-2026-000152' },
  { id: 'm8', mineral: 'wolframite', grade: 65.0, quantity: 35, unit: 'ton', priceAmount: 21600000, priceCurrency: 'NGN', state: 'Kano', status: 'approved', certified: true, sellerName: SELLER_CO, sellerVerified: true, sellerRating: 4.6, deliveryMode: 'pickup', locationType: 'mine', trend: spark(8), createdAt: '09 Feb 2025', passportNumber: 'GO-WO-2026-000154' },
  { id: 'm9', mineral: 'monazite', grade: 57.8, quantity: 45, unit: 'ton', priceAmount: 19800000, priceCurrency: 'NGN', state: 'Plateau', status: 'approved', certified: true, sellerName: SELLER_CO, sellerVerified: true, sellerRating: 4.4, deliveryMode: 'delivery', locationType: 'mine', trend: spark(3), createdAt: '08 Feb 2025', passportNumber: 'GO-CE-2026-000156' },
  { id: 'm10', mineral: 'tantalite', grade: 42.6, quantity: 30, unit: 'ton', priceAmount: 33000000, priceCurrency: 'NGN', state: 'Nasarawa', status: 'approved', certified: true, sellerName: SELLER_CO, sellerVerified: true, sellerRating: 4.7, deliveryMode: 'pickup', locationType: 'mine', trend: spark(5), createdAt: '07 Feb 2025', passportNumber: 'GO-TA-2026-000158' },
  { id: 'm11', mineral: 'beryllium', grade: 11.8, quantity: 25, unit: 'ton', priceAmount: 14500000, priceCurrency: 'NGN', state: 'Kaduna', status: 'approved', certified: true, sellerName: SELLER_CO, sellerVerified: true, sellerRating: 4.2, deliveryMode: 'delivery', locationType: 'warehouse', trend: spark(4), createdAt: '06 Feb 2025', passportNumber: 'GO-BE-2026-000160' },
  { id: 'm12', mineral: 'spodumene', grade: 6.0, quantity: 100, unit: 'ton', priceAmount: 9200000, priceCurrency: 'NGN', state: 'Ekiti', status: 'approved', certified: true, sellerName: SELLER_CO, sellerVerified: true, sellerRating: 4.5, deliveryMode: 'delivery', locationType: 'mine', trend: spark(7), createdAt: '05 Feb 2025', passportNumber: 'GO-SP-2026-000162' },
]
...
export const PASSPORTS: Passport[] = [
  ...
  marketPassport('GO-CU-2026-000152', 'copper', 'Copper Concentrate', 32.5, '32.5% Cu', 80, 'ton', SELLER_CO, 'Kaltungo Copper Field', 'Gombe', { lat: 9.8206, lng: 11.3096 }, 'Open Pit', 'BTH-CUP-0152',
    [{ label: 'Copper', formula: 'Cu', value: 32.5 }, { label: 'Sulphur', formula: 'S', value: 28.6 }, { label: 'Iron', formula: 'Fe', value: 24.1 }, { label: 'Silica', formula: 'SiO₂', value: 13.8 }, { label: 'Moisture', formula: 'H₂O', value: 1.0 }],
    { overall: 86, environmental: 84, social: 87, governance: 88, supplyChain: 86 }, 15.8, 1.9),
  marketPassport('GO-WO-2026-000154', 'wolframite', 'Wolframite Concentrate', 65.0, '65.0% WO₃', 35, 'ton', SELLER_CO, 'Ririwai Wolframite Lode', 'Kano', { lat: 10.5539, lng: 8.7519 }, 'Hard-Rock / Lode', 'BTH-WOL-0154',
    [{ label: 'Tungsten Trioxide', formula: 'WO₃', value: 65.0 }, { label: 'Iron Oxide', formula: 'FeO', value: 9.5 }, { label: 'Manganese Oxide', formula: 'MnO', value: 8.8 }, { label: 'Silica', formula: 'SiO₂', value: 15.7 }, { label: 'Moisture', formula: 'H₂O', value: 1.0 }],
    { overall: 88, environmental: 87, social: 89, governance: 89, supplyChain: 88 }, 11.6, 1.7),
  marketPassport('GO-CE-2026-000156', 'monazite', 'Monazite Concentrate', 57.8, '57.8% REO', 45, 'ton', SELLER_CO, 'Bukuru Monazite Field', 'Plateau', { lat: 9.7963, lng: 8.8583 }, 'Alluvial', 'BTH-MON-0156',
    [{ label: 'Rare Earth Oxides', formula: 'REO', value: 57.8 }, { label: 'Phosphorus Pentoxide', formula: 'P₂O₅', value: 27.0 }, { label: 'Thorium Oxide', formula: 'ThO₂', value: 5.4 }, { label: 'Silica', formula: 'SiO₂', value: 8.9 }, { label: 'Moisture', formula: 'H₂O', value: 0.9 }],
    { overall: 85, environmental: 83, social: 86, governance: 87, supplyChain: 85 }, 14.2, 1.8),
  marketPassport('GO-TA-2026-000158', 'tantalite', 'Tantalite Concentrate', 42.6, '42.6% Ta₂O₅', 30, 'ton', SELLER_CO, 'Wamba Tantalite Field', 'Nasarawa', { lat: 8.9401, lng: 8.6013 }, 'Open Pit / Pegmatite', 'BTH-TAN-0158',
    [{ label: 'Tantalum Oxide', formula: 'Ta₂O₅', value: 42.6 }, { label: 'Niobium Oxide', formula: 'Nb₂O₅', value: 24.3 }, { label: 'Iron', formula: 'Fe', value: 18.1 }, { label: 'Manganese', formula: 'Mn', value: 8.4 }, { label: 'Moisture', formula: 'H₂O', value: 0.6 }],
    { overall: 90, environmental: 89, social: 91, governance: 92, supplyChain: 90 }, 10.8, 1.6),
  marketPassport('GO-BE-2026-000160', 'beryllium', 'Beryl Concentrate', 11.8, '11.8% BeO', 25, 'ton', SELLER_CO, "Jema'a Beryl Field", 'Kaduna', { lat: 9.4218, lng: 8.2028 }, 'Pegmatite', 'BTH-BER-0160',
    [{ label: 'Beryllium Oxide', formula: 'BeO', value: 11.8 }, { label: 'Silica', formula: 'SiO₂', value: 64.2 }, { label: 'Alumina', formula: 'Al₂O₃', value: 18.4 }, { label: 'Iron Oxide', formula: 'Fe₂O₃', value: 1.2 }, { label: 'Moisture', formula: 'H₂O', value: 0.5 }],
    { overall: 87, environmental: 86, social: 88, governance: 88, supplyChain: 87 }, 12.9, 1.7),
  marketPassport('GO-SP-2026-000162', 'spodumene', 'Spodumene Concentrate', 6.0, '6.0% Li₂O', 100, 'ton', SELLER_CO, 'Ijero Spodumene Field', 'Ekiti', { lat: 7.8140, lng: 5.0656 }, 'Hard-Rock Pegmatite', 'BTH-SPD-0162',
    [{ label: 'Lithium Oxide', formula: 'Li₂O', value: 6.0 }, { label: 'Silica', formula: 'SiO₂', value: 64.1 }, { label: 'Alumina', formula: 'Al₂O₃', value: 27.4 }, { label: 'Iron Oxide', formula: 'Fe₂O₃', value: 0.9 }, { label: 'Moisture', formula: 'H₂O', value: 0.4 }],
    { overall: 91, environmental: 92, social: 90, governance: 91, supplyChain: 92 }, 9.8, 1.5),
]
